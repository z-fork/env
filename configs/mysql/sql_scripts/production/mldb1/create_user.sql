...
GRANT ALL ON router.* to 'kratos_v2'@'50.22.158.%';
GRANT ALL ON router.* to 'kratos_v2'@'10.28.%';

GRANT ALL ON db1.* to 'kratos_v2'@'localhost';
GRANT ALL ON db1.* to 'kratos_v2'@'50.22.158.%';
GRANT ALL ON db1.* to 'kratos_v2'@'10.28.%';

GRANT ALL ON db2.* to 'kratos_v2'@'localhost';
GRANT ALL ON db2.* to 'kratos_v2'@'50.22.158.%';
GRANT ALL ON db2.* to 'kratos_v2'@'10.28.%';
